...
package datasource_server_list
...
func ServerListDataSourceSchema(ctx context.Context) schema.Schema {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"status": schema.SingleNestedAttribute{
							...
							MarkdownDescription: "ServerStatus defines the observed state of Server",
						},
					},
