...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/datasource_server"
...
const read_ds_server = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/servers/{name}"
...
func (d *serverDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_server, map[string]string{
...
func (r *serverDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
