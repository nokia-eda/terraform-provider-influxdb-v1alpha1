...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/resource_server"
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/tfutils"
)

const (
	create_rs_server = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/servers"
	read_rs_server   = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/servers/{name}"
	update_rs_server = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/servers/{name}"
	delete_rs_server = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/servers/{name}"
)
...
func (r *serverResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_server, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_server, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *serverResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_server, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *serverResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_server, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
