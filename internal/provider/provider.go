...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/eda/utils"
...
var _ provider.Provider = (*influxdbProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &influxdbProvider{version: ver}
	}
}
...
func (p *influxdbProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "influxdb-v1alpha1"
...
func (p *influxdbProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewClusterExportDataSource,
		NewClusterExportListDataSource,
		NewClusterServerDataSource,
		NewClusterServerListDataSource,
		NewExportDataSource,
		NewExportListDataSource,
		NewResourceListDataSource,
		NewServerDataSource,
		NewServerListDataSource,
	}
}

func (p *influxdbProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterExportResource,
		NewClusterServerResource,
		NewExportResource,
		NewServerResource,
	}
}
