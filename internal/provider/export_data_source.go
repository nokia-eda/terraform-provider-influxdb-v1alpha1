...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/datasource_export"
...
const read_ds_export = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"

var (
	_ datasource.DataSource              = (*exportDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*exportDataSource)(nil)
)
...
func (d *exportDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_export, map[string]string{
