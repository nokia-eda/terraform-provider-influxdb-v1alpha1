...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/resource_export"
	"github.com/nokia/eda/apps/terraform-provider-influxdb/internal/tfutils"
)

const (
	create_rs_export = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports"
	read_rs_export   = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
	update_rs_export = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
	delete_rs_export = "/apps/influxdb.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"
)
...
func (r *exportResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_export, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_export, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *exportResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_export, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *exportResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_export, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
