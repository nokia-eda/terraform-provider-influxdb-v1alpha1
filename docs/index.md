---
page_title: "influxdb-v1alpha1 Provider"
---

# influxdb-v1alpha1 Provider

This provider is used to interact with the resources provided by the **influxdb-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
